...
if __name__ == '__main__':
    ...
    policy_file = open('Class_Reward_0-3Grid_RL_Eval_depth2.txt', 'w')
    policy_file.write(
    ...
    with torch.no_grad():
        class_reward_leaf_tree_depth = 2
        class_reward_leaf_tree_input_size = 28 * 28
        class_reward_leaf_tree_vector = [0, 1, 2, 3]
        ...
        class_reward_leaf_tree = torch.load('Trained_Reward_Models/mnist0-3/DDT/CRL/WOP-2_LONG_NoES_100')
        ...
        for sd in range(0,100,1):
            ...
            print(f" For seed {seed}, the GT reward {gridworld_gt_reward}, DDT soft {np.round(Class_Leaf_r_hat_gridworld_SOFT,decimals=4)} ,DDT Argmax{Class_Leaf_r_hat_gridworld_ArgMax}")
