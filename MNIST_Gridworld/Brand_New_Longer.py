...
if __name__=="__main__":
    ...
    train(traj_length=5,pairwise_batch_size=50,no_train_batches=3000,training_dataset=training_dataset,num_epochs=100,ddt=tree,optimizer=optimizer ,validation_dataset=validation_dataset,no_val_batches=500)
