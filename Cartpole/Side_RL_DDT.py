...
parser.add_argument('--save_model_dir', default="Misalignment/RL_using_DDT/", help="where to save trained model")
parser.add_argument('--pth', default="Misalignment/RL_runs_TB/RL_using_DDT/", help="path where tensorboard events are stored")
...
if __name__=="__main__":
    ...
    total_timesteps = 5e5
    trained_DDT_path= '/home/ak/Documents/Clean_Cartpole_DDT/Reward_Models/DDT/saved_models/CP-1_50'
